            ...
            <Col lg="6" md="6">
                 <div className='hero__content mb-4'>
                   ...
                   <div className='mt-4 hero__btns d-flex align-items-center gap-4'>
                       <button className='resumee-btnn'><a target="_blank" href={"https://drive.google.com/file/d/1dboQYHtNNi9YKidxc8SAin9we5JGEAgK/view?usp=share_link"} _blank download>Resume</a></button>
